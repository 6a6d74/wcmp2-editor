...
- **Controlled vocabulary pickers** sourced live from the [WMO Codes Registry](https://codes.wmo.int) (Earth System Disciplines, resource types, link relations) and the [WCMP2 codelists repository](https://github.com/wmo-im/wcmp2-codelists) (contact roles), with static fallbacks when offline. Contact roles are restricted to the five defined in the WCMP2 standard: `licensor`, `producer`, `processor`, `host`, and `publisher`
